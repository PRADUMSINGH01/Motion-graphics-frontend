    ...
    <div className="relative min-h-screen bg-[#090a0f] text-slate-300 font-poppins pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-3 pb-8 border-b border-white/10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-blue-500/10 text-blue-300 border border-blue-400/20">
          ...
          <p className="text-sm sm:text-base text-slate-400 leading-relaxed font-poppins pt-1">
        ...
        <div className="my-10 grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-4 rounded-2xl bg-[#121319]/80 border border-white/10 backdrop-blur-xl text-center space-y-1">
            <span className="text-2xl sm:text-3xl font-bold text-white font-comic">60 FPS</span>
            <span className="text-[11px] text-slate-400 block font-poppins">Fluid Canvas Playback</span>
          </div>
          <div className="p-4 rounded-2xl bg-[#121319]/80 border border-white/10 backdrop-blur-xl text-center space-y-1">
            <span className="text-2xl sm:text-3xl font-bold text-cyan-400 font-comic">4.8M+</span>
            <span className="text-[11px] text-slate-400 block font-poppins">Rendered Frames</span>
          </div>
          <div className="p-4 rounded-2xl bg-[#121319]/80 border border-white/10 backdrop-blur-xl text-center space-y-1">
            <span className="text-2xl sm:text-3xl font-bold text-emerald-400 font-comic">100%</span>
            <span className="text-[11px] text-slate-400 block font-poppins">Commercial Ownership</span>
          </div>
          <div className="p-4 rounded-2xl bg-[#121319]/80 border border-white/10 backdrop-blur-xl text-center space-y-1">
            <span className="text-2xl sm:text-3xl font-bold text-purple-400 font-comic">Zero</span>
            <span className="text-[11px] text-slate-400 block font-poppins">Customer Data Training</span>
          </div>
        </div>
