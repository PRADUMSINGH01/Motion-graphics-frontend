  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-[#090a0f] text-slate-700 dark:text-slate-300 font-poppins pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-8">
          {productModules.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="group relative p-6 rounded-3xl bg-white/90 dark:bg-[#0e0f14]/90 border border-black/10 dark:border-white/10 hover:border-cyan-500/40 dark:hover:border-cyan-400/40 backdrop-blur-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10 space-y-4"
              >
                {/* Header Icon + Badge */}
                <div className="flex items-center justify-between">
                  <div className="w-11 h-11 rounded-2xl bg-slate-100 dark:bg-white/[0.05] border border-black/10 dark:border-white/10 flex items-center justify-center text-cyan-600 dark:text-cyan-400 group-hover:text-cyan-700 dark:group-hover:text-white group-hover:bg-cyan-500/20 transition-colors">
                    <Icon className="w-5 h-5" />
                  </div>
                  <span className="px-2.5 py-0.5 text-[10px] font-mono font-semibold uppercase tracking-wider rounded-full bg-slate-100 dark:bg-white/[0.06] text-cyan-700 dark:text-cyan-300 border border-black/10 dark:border-white/10">
                    {item.badge}
                  </span>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white font-comic group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors leading-snug">
                    {item.title}
                  </h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-poppins pt-1">
                    {item.description}
                  </p>
                </div>

                {/* Specs Pill List */}
                <div className="pt-3 border-t border-black/10 dark:border-white/[0.06] space-y-1.5">
                  {item.specs.map((spec) => (
                    <div key={spec} className="flex items-center gap-2 text-[11px] text-slate-700 dark:text-slate-300">
                      <FiCheckCircle className="w-3 h-3 text-emerald-600 dark:text-emerald-400 shrink-0" />
                      <span>{spec}</span>
                    </div>
                  ))}
                </div>
        ...
        <div className="my-16 p-8 rounded-3xl bg-white/90 dark:bg-[#0e0f14]/90 border border-black/10 dark:border-white/10 backdrop-blur-2xl space-y-6 shadow-xl">
          <div className="text-center space-y-1.5 max-w-xl mx-auto">
            <span className="text-xs font-mono text-cyan-700 dark:text-cyan-400 uppercase tracking-widest font-semibold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.06] space-y-2">
              <span className="w-7 h-7 rounded-xl bg-cyan-500/20 text-cyan-700 dark:text-cyan-300 font-mono text-xs flex items-center justify-center font-bold">
                01
              </span>
              <h4 className="text-sm font-bold text-slate-900 dark:text-white font-comic">Prompt &amp; Parameter Input</h4>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.06] space-y-2">
              <span className="w-7 h-7 rounded-xl bg-purple-500/20 text-purple-700 dark:text-purple-300 font-mono text-xs flex items-center justify-center font-bold">
                02
              </span>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.06] space-y-2">
              <span className="w-7 h-7 rounded-xl bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 font-mono text-xs flex items-center justify-center font-bold">
                03
              </span>
              <h4 className="text-sm font-bold text-slate-900 dark:text-white font-comic">Lossless Multi-Export</h4>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="my-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-8 rounded-3xl bg-white/90 dark:bg-gradient-to-br dark:from-[#0e0f14]/95 dark:via-[#11131a]/90 dark:to-[#0e1620]/90 border border-emerald-500/30 backdrop-blur-2xl space-y-6 relative overflow-hidden shadow-xl">
            <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-500/10 blur-3xl pointer-events-none" />
            
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-emerald-500/15 border border-emerald-400/30 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
                <FiKey className="w-6 h-6" />
              </div>
              <span className="px-3 py-1 rounded-full text-xs font-mono font-bold bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-400/30">
                REST &amp; SDK v1
              </span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-950 dark:bg-black/40 border border-black/20 dark:border-white/10 font-mono text-xs text-slate-300 space-y-2">
            ...
            <div className="pt-2 flex items-center gap-4">
              ...
              <Link
                href="/api-keys"
                className="text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white transition-colors"
              >
                Read Documentation →
              </Link>
            </div>
          ...
          <div className="p-8 rounded-3xl bg-white/90 dark:bg-gradient-to-br dark:from-[#0e0f14]/95 dark:via-[#14121a]/90 dark:to-[#180e20]/90 border border-purple-500/30 backdrop-blur-2xl space-y-6 relative overflow-hidden shadow-xl">
            <div className="absolute top-0 right-0 w-48 h-48 bg-purple-500/10 blur-3xl pointer-events-none" />

            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-purple-500/15 border border-purple-400/30 flex items-center justify-center text-purple-600 dark:text-purple-400">
                <FiCpu className="w-6 h-6" />
              </div>
              <span className="px-3 py-1 rounded-full text-xs font-mono font-bold bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-400/30">
                Incoming Projects
              </span>
            </div>
            ...
            <div className="space-y-3">
              {/* Agent 1 */}
              <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.08]">
                <div className="w-8 h-8 rounded-lg bg-purple-500/20 text-purple-700 dark:text-purple-300 flex items-center justify-center shrink-0">
                  <FiLayers className="w-4 h-4" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-slate-900 dark:text-white font-comic">Vector Morph Agent</span>
                    <span className="text-[10px] font-mono text-purple-700 dark:text-purple-300 bg-purple-500/20 px-2 py-0.5 rounded">Coming Q4</span>
                  </div>
              ...
              <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.08]">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-slate-900 dark:text-white font-comic">3D Physics Rig Agent</span>
                    <span className="text-[10px] font-mono text-amber-700 dark:text-amber-300 bg-amber-500/20 px-2 py-0.5 rounded">Private Alpha</span>
                  </div>
                  <p className="text-[11px] text-slate-600 dark:text-slate-400 mt-0.5">
              ...
              {/* Agent 3 */}
              <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.08]">
                <div className="w-8 h-8 rounded-lg bg-pink-500/20 text-pink-700 dark:text-pink-300 flex items-center justify-center shrink-0">
                  <FiFilm className="w-4 h-4" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-slate-900 dark:text-white font-comic">Voice2Motion Agent</span>
                    <span className="text-[10px] font-mono text-pink-700 dark:text-pink-300 bg-pink-500/20 px-2 py-0.5 rounded">In Dev</span>
                  </div>
                  <p className="text-[11px] text-slate-600 dark:text-slate-400 mt-0.5">
        ...
        <div className="mt-12 p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-purple-500/10 via-slate-100 to-blue-500/10 dark:from-purple-950/40 dark:via-[#121319]/90 dark:to-blue-950/40 border border-cyan-500/30 backdrop-blur-2xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left shadow-lg">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link
              href="/register"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 dark:text-slate-900 dark:bg-white dark:hover:bg-slate-100 transition-colors shadow-lg"
            >
            ...
            <Link
              href="/explore"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-slate-900 dark:text-white bg-slate-200/80 hover:bg-slate-300 dark:bg-white/10 dark:hover:bg-white/15 border border-black/10 dark:border-white/15 transition-colors"
            >
